...
public class Jpake1bRequest: Message {
    ...
    public init(appInstanceId: Int, centralChallenge: Data) {
        ...
        cargo = Jpake1bRequest.buildCargo(appInstanceId: appInstanceId, centralChallenge: centralChallenge)
...
public class Jpake1bResponse: Message {
    ...
    public init(appInstanceId: Int, centralChallengeHash: Data) {
        ...
        cargo = Jpake1bResponse.buildCargo(appInstanceId: appInstanceId, centralChallengeHash: centralChallengeHash)
        self.appInstanceId = appInstanceId
