...
final class TandemPumpPairingViewController: UIViewController {
    ...
    private lazy var instructionsLabel: UILabel = {
        ...
        label.text = LocalizedString("Enter the pairing code from your pump to begin pairing.", comment: "Instructions for Tandem pairing UI")
        return label
    }()
    ...
    private func configureLayout() {
        let stackView = UIStackView(arrangedSubviews: [instructionsLabel, pairingCodeField, pairButton, activityIndicator, statusLabel])
    ...
    private func showStatus(_ result: Result<Void, Error>) {
        ...
        case .success:
            ...
            statusLabel.text = LocalizedString("Pairing request sent. Follow the prompts on your pump.", comment: "Success message for Tandem pump pairing")
        case .failure(let error):
            statusLabel.textColor = .systemRed
            statusLabel.text = [error.localizedDescription, error.recoverySuggestion].compactMap { $0 }.joined(separator: "\n")
        }
